...
/**
 * Класс выводит кассовы чек, используя данные файла в определённом формате:
 * Название товара
 * количество
 * цена
 */
public class CashReceipt {
    ...
    public static void printReceiptString(String cashReceiptString) {
        MyCashReceipt.log.info(cashReceiptString);
    }
    ...
    public static void printReceiptString(String pattern, String name, String price, String count, String cost) {
        try (Formatter cashReceiptFormatter = new Formatter()) {
            ...
            MyCashReceipt.log.info(cashReceiptFormatter);
        } catch (Exception e) {
            MyCashReceipt.log.error(e.fillInStackTrace());
        }
    }
